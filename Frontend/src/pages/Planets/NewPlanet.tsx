...
import { ToggablePlanet, useConfirmPlanet} from "../../components/Planet";
...
const CreateNewPlanet = () => {
    ...
    function CheckValues() {
        ...
        ExecuteRequest(axios.post('planets/', {name: planetNameRef.current!.value, type: planetType }), OnPlanetCreated);
